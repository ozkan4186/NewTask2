...
const Navbar = () => {
  ...
  return (
    <div>
      <section className="relative flex h-[600px] min-h-full items-start justify-center overflow-y-hidden border bg-gray-50 light:border-zinc-900 light:bg-zinc-700">
        {/* Sidenav */}
        <nav
          id="sidenav-6"
          ...
          >
            ...
            <li className="relative">
              ...
              >
                ...
                <span>Bileşen Ekle ve Çikar </span>
                <span
